...
class _AnaSayfaState extends State<AnaSayfa> {
  ...
  Widget build(BuildContext context) {
    var veri = [];
    veri = ModalRoute.of(context)!.settings.arguments as dynamic ;
    uyead = veri[0];

    return Scaffold(
        appBar: AppBar(
        title:  Text('SAĞLIKLI YAŞAM SAĞLIKLI İNSAN',
          style: GoogleFonts.rubikBeastly(fontSize: 40.0, color: Colors.green),
        ),
          centerTitle: true,
        ...
        children: <Widget>[
          ...
          Padding(padding: const EdgeInsets.only(right: 450.0 ),
            child: Column(
                ...
                children: <Widget>[
                  Text('HOŞGELDİN: ' + uyead, style: GoogleFonts.ultra(fontSize: 18.0, color: Colors.blueGrey),
                  ),
